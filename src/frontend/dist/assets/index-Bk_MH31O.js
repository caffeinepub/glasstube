  ...
  try {
    ...
    if (vRes.ok) {
      ...
      availableIds = new Set(
        (vData.items || []).filter(isAvailable).map((i) => i.id)
      );
    }
  } catch {
  }
  const results = rawResults.filter(
    (v2) => availableIds.has(v2.id)
  );
    ...
    if (keywords.trim()) {
      try {
        ...
        if (res.ok) {
          ...
          const rawResults = (data.items || []).map((item) => {
            var _a2;
            const vid = ((_a2 = item.id) == null ? void 0 : _a2.videoId) || item.id;
            return {
              id: vid,
              title: item.snippet.title,
              channelTitle: item.snippet.channelTitle,
          ...
          const results = rawResults.filter((v2) => availableIds.has(v2.id));
          if (results.length >= 6) {
            const channelIds = [
              ...new Set(
...
function WatchPage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fade-in", "data-ocid": "player.panel", style: {}, children: [
        ...
        children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", "data-ocid": "video.loading_state", children: [
          ...
          descExpanded && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { fontSize: 13, color: "#717171", marginBottom: 8 }, children: [
                  formatViews(video.viewCount),
                  " views •",
                  " ",
              ...
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#717171", fontSize: 12 }, children: "1.2M subscribers" })
                  ] })
                ]
              }
            ),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { overflow: "hidden", textOverflow: "ellipsis" }, children: formatLikes(video.likeCount) })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { overflow: "hidden", textOverflow: "ellipsis" }, children: video.duration || "--:--" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { overflow: "hidden", textOverflow: "ellipsis" }, children: copySuccess ? "Copied!" : "Copy Link" })
                    ]
                  }
                )
              ]
        ...
        "div",
        {
          ...
          children: commentsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            "p",
            {
              ...
              children: "Comments are disabled for this video."
            }
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", style: { background: "#000000" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(BottomNav, { currentPage, onNavigate: handleNavigate }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster, {})
  ] });
}
