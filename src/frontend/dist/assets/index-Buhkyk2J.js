...
function BottomNav({ currentPage, onNavigate }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "nav",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center w-full", style: { height: 60 }, children: NAV_ITEMS.map((item) => {
        const active = currentPage === item.id || item.id === "home" && ["home", "music", "gaming", "news", "sports"].includes(
          currentPage
        );
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, { active }),
...
function HomeIcon({ active }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "svg",
    {
      ...
      children: active ? /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M12 5.69l5 4.5V18h-2v-6H9v6H7v-7.81l5-4.5M12 3L2 12h3v8h6v-6h2v6h6v-8h3L12 3z" })
    }
  );
}
function TrendingIcon({ active }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "svg",
    {
      ...
      viewBox: "0 0 24 24",
      fill: active ? "#FF0000" : "#717171",
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M17.2 6.3L13.7 9.8 11 7.1 6 12.1l1.4 1.4 3.6-3.6 2.7 2.7 4.9-4.9L17.2 6.3zM4 18h16v2H4z" })
    }
  );
}
function HistoryIcon({ active }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "svg",
    {
      ...
      viewBox: "0 0 24 24",
      fill: active ? "#FF0000" : "#717171",
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M13 3a9 9 0 100 18A9 9 0 0013 3zm0 16a7 7 0 110-14 7 7 0 010 14zm.5-11H12v6l5.25 3.15.75-1.23-4.5-2.67V8z" })
    }
  );
}
...
function addToSearchCache(query) {
...
function TopBar({ onSearch, onNavigate, currentQuery }) {
  const [query, setQuery] = reactExports.useState(currentQuery || "");
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, minWidth: 0 } }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                style: {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "form",
                    {
                      ...
                      style: {
                        ...
                        padding: "0 6px",
                        gap: 4,
                        border: focused ? "1.5px solid rgba(255,0,0,0.75)" : "1.5px solid rgba(255,0,0,0.3)",
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "svg",
                          {
                            ...
                            viewBox: "0 0 24 24",
                            style: { flexShrink: 0 },
                            children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M20.87 20.17l-5.59-5.59C16.35 13.35 17 11.75 17 10c0-3.87-3.13-7-7-7s-7 3.13-7 7 3.13 7 7 7c1.75 0 3.35-.65 4.58-1.71l5.59 5.59.7-.71zM10 16c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6z" })
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "input",
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "svg",
                              {
                                ...
                                fill: "#555",
                                viewBox: "0 0 24 24",
                                children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z" })
                              }
                            ),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "span",
...
function usePwaInstall() {
  const [promptEvent, setPromptEvent] = reactExports.useState(null);
  ...
  const canInstall = !!promptEvent && !installed;
  return { canInstall, install };
}
const CACHE_PREFIX = "yt_cache_";
const DEFAULT_TTL_MS = 10 * 60 * 1e3;
const CHANNEL_TTL_MS = 30 * 60 * 1e3;
...
function clearOldCacheEntries() {
  try {
    ...
    for (let i = 0; i < localStorage.length; i++) {
      ...
      if (k == null ? void 0 : k.startsWith(CACHE_PREFIX)) {
        try {
...
function bestThumb(thumbnails, videoId) {
  var _a2, _b2, _c2, _d2, _e2;
  return ((_a2 = thumbnails == null ? void 0 : thumbnails.maxres) == null ? void 0 : _a2.url) || ((_b2 = thumbnails == null ? void 0 : thumbnails.standard) == null ? void 0 : _b2.url) || ((_c2 = thumbnails == null ? void 0 : thumbnails.high) == null ? void 0 : _c2.url) || ((_d2 = thumbnails == null ? void 0 : thumbnails.medium) == null ? void 0 : _d2.url) || ((_e2 = thumbnails == null ? void 0 : thumbnails.default) == null ? void 0 : _e2.url) || (videoId ? getYtThumbnail(videoId) : "");
}
    ...
    try {
      ...
      if (res.ok) {
        ...
        for (const item of data.items || []) {
          const thumb = ((_c2 = (_b2 = (_a2 = item.snippet) == null ? void 0 : _a2.thumbnails) == null ? void 0 : _b2.medium) == null ? void 0 : _c2.url) || ((_f2 = (_e2 = (_d2 = item.snippet) == null ? void 0 : _d2.thumbnails) == null ? void 0 : _e2.default) == null ? void 0 : _f2.url) || "";
...
async function fetchTrending(categoryId) {
  var _a2;
  ...
  if (!res.ok) {
    ...
    throw new Error(((_a2 = err == null ? void 0 : err.error) == null ? void 0 : _a2.message) || "Failed to fetch videos");
  }
  const data = await res.json();
  const videos = (data.items || []).filter((item) => isAvailable(item)).map((item) => {
    var _a3, _b2, _c2;
    return {
      id: item.id,
      ...
      viewCount: ((_a3 = item.statistics) == null ? void 0 : _a3.viewCount) || "0",
      likeCount: ((_b2 = item.statistics) == null ? void 0 : _b2.likeCount) || "0",
      publishedAt: item.snippet.publishedAt,
      description: item.snippet.description,
      categoryId: item.snippet.categoryId,
      duration: parseDuration(((_c2 = item.contentDetails) == null ? void 0 : _c2.duration) || "")
    };
  });
  const channelIds = [...new Set(videos.map((v2) => v2.channelId))];
  const thumbs = await fetchChannelThumbnails(channelIds);
  const result = videos.map((v2) => ({
    ...v2,
    channelThumbnail: thumbs[v2.channelId] || ""
  }));
...
function extractKeywords(title) {
  ...
  return title.replace(/[^a-zA-Z0-9 ]/g, " ").split(/\s+/).filter((w) => w.length > 2 && !stop.has(w.toLowerCase())).slice(0, 4).join(" ");
}
async function searchVideos(query) {
  ...
  if (!res.ok) {
    const err = await res.json();
    throw new Error(((_a2 = err == null ? void 0 : err.error) == null ? void 0 : _a2.message) || "Failed to search videos");
  }
  const data = await res.json();
  const rawResults = (data.items || []).map((item) => {
    var _a3;
    const vid = ((_a3 = item.id) == null ? void 0 : _a3.videoId) || item.id;
    return {
      id: vid,
      title: item.snippet.title,
      channelTitle: item.snippet.channelTitle,
  ...
  const ids = rawResults.map((v2) => v2.id).join(",");
  let availableIds = new Set(rawResults.map((v2) => v2.id));
  const durationMap = {};
  try {
    ...
    if (vRes.ok) {
      ...
      availableIds = new Set(available.map((i) => i.id));
      for (const item of available) {
        durationMap[item.id] = parseDuration(
          ((_b2 = item.contentDetails) == null ? void 0 : _b2.duration) || ""
        );
      }
    }
  } catch {
  }
  const results = rawResults.filter((v2) => availableIds.has(v2.id)).map((v2) => ({ ...v2, duration: durationMap[v2.id] || "" }));
  const channelIds = [...new Set(results.map((v2) => v2.channelId))];
  const thumbs = await fetchChannelThumbnails(channelIds);
  const final = results.map((v2) => ({
    ...v2,
    channelThumbnail: thumbs[v2.channelId] || ""
  }));
...
async function fetchVideoDetails(videoId) {
  ...
  if (!res.ok) {
    const err = await res.json();
    throw new Error(((_a2 = err == null ? void 0 : err.error) == null ? void 0 : _a2.message) || "Failed to fetch video details");
  }
  const data = await res.json();
  const item = (_b2 = data.items) == null ? void 0 : _b2[0];
  if (!item) return null;
  const video = {
    id: item.id,
    title: item.snippet.title,
    ...
    channelId: item.snippet.channelId,
    thumbnail: bestThumb(item.snippet.thumbnails, item.id),
    viewCount: ((_c2 = item.statistics) == null ? void 0 : _c2.viewCount) || "0",
    likeCount: ((_d2 = item.statistics) == null ? void 0 : _d2.likeCount) || "0",
    publishedAt: item.snippet.publishedAt,
    description: item.snippet.description,
    categoryId: item.snippet.categoryId,
    duration: parseDuration(((_e2 = item.contentDetails) == null ? void 0 : _e2.duration) || "")
  };
...
async function fetchVideoComments(videoId) {
  ...
  try {
    ...
    const comments = (data.items || []).map((item) => {
      var _a2, _b2;
      const top = (_b2 = (_a2 = item.snippet) == null ? void 0 : _a2.topLevelComment) == null ? void 0 : _b2.snippet;
      return {
        id: item.id,
        authorName: (top == null ? void 0 : top.authorDisplayName) || "Anonymous",
        authorAvatar: (top == null ? void 0 : top.authorProfileImageUrl) || "",
        text: (top == null ? void 0 : top.textDisplay) || "",
        likeCount: (top == null ? void 0 : top.likeCount) || 0,
        publishedAt: (top == null ? void 0 : top.publishedAt) || ""
      };
    });
...
async function fetchInterestVideos(historyTitles, historyCategoryIds) {
  var _a2;
  const key = getApiKey();
        ...
        if (res.ok) {
          ...
          try {
            ...
            if (vRes.ok) {
              ...
              availableIds = new Set(avail.map((i) => i.id));
              for (const item of avail) {
                durMap[item.id] = parseDuration(
                  ((_a2 = item.contentDetails) == null ? void 0 : _a2.duration) || ""
                );
              }
            }
          } catch {
          }
          const results = rawResults.filter((v2) => availableIds.has(v2.id)).map((v2) => ({ ...v2, duration: durMap[v2.id] || "" }));
          if (results.length >= 6) {
            const channelIds = [
              ...new Set(
                results.map((v2) => v2.channelId)
              )
            ];
            const thumbs = await fetchChannelThumbnails(channelIds);
            const final = results.map((v2) => ({
...
async function fetchChannelVideos(channelId) {
  ...
  const ch = (_a2 = channelData.items) == null ? void 0 : _a2[0];
  const channel = {
    id: channelId,
    title: ((_b2 = ch == null ? void 0 : ch.snippet) == null ? void 0 : _b2.title) || "",
    thumbnail: ((_e2 = (_d2 = (_c2 = ch == null ? void 0 : ch.snippet) == null ? void 0 : _c2.thumbnails) == null ? void 0 : _d2.medium) == null ? void 0 : _e2.url) || ((_h2 = (_g2 = (_f2 = ch == null ? void 0 : ch.snippet) == null ? void 0 : _f2.thumbnails) == null ? void 0 : _g2.default) == null ? void 0 : _h2.url) || "",
    description: ((_i2 = ch == null ? void 0 : ch.snippet) == null ? void 0 : _i2.description) || "",
    subscriberCount: ((_j = ch == null ? void 0 : ch.statistics) == null ? void 0 : _j.subscriberCount) || "0"
  };
  const searchData = await searchRes.json();
  const rawVideos = (searchData.items || []).map((item) => {
    var _a3;
    const vid = ((_a3 = item.id) == null ? void 0 : _a3.videoId) || item.id;
    return {
      id: vid,
  ...
  const ids = rawVideos.map((v2) => v2.id).join(",");
  let availableIds = new Set(rawVideos.map((v2) => v2.id));
  const durMap = {};
  try {
    const vRes = await fetch(
      `${BASE}/videos?part=contentDetails,status&id=${ids}&key=${key}`
    ...
    if (vRes.ok) {
      ...
      availableIds = new Set(avail.map((i) => i.id));
      for (const item of avail) {
        durMap[item.id] = parseDuration(((_k = item.contentDetails) == null ? void 0 : _k.duration) || "");
      }
    }
  } catch {
  }
  const videos = rawVideos.filter((v2) => availableIds.has(v2.id)).map((v2) => ({ ...v2, duration: durMap[v2.id] || "" }));
...
function timeAgo(dateStr) {
  ...
  const diff = Math.floor((now2.getTime() - date.getTime()) / 1e3);
...
function isFullVideo(v2) {
  return "viewCount" in v2;
}
...
function getAvatarColor$1(name) {
  let hash = 0;
  for (let i = 0; i < name.length; i++)
    hash = name.charCodeAt(i) + ((hash << 5) - hash);
  return AVATAR_COLORS$1[Math.abs(hash) % AVATAR_COLORS$1.length];
}
function VideoCard({
  video,
  onWatch,
  ...
  const ocid = index2 !== void 0 && index2 < 3 ? `video.item.${index2 + 1}` : void 0;
  const avatarColor = getAvatarColor$1(video.channelTitle);
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: {
            ...
            transition: pressed ? "transform 100ms ease-out, filter 100ms ease-out" : "transform 300ms cubic-bezier(0.34,1.56,0.64,1), filter 300ms ease-out",
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      video.duration && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          style: {
                            position: "absolute",
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
                          {
                            ...
                            "aria-hidden": "true",
                            children: video.channelThumbnail ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "img",
                              {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: 12, color: "#717171" }, children: [
                          isFullVideo(video) && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                            formatViews(video.viewCount),
                            " views • "
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: timeAgo(video.publishedAt) })
                        ] })
                      ]
                    }
                  )
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "yt-skeleton w-full", style: { aspectRatio: "16/9" } }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "yt-skeleton w-7 h-7 rounded-full flex-shrink-0" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "yt-skeleton h-3 w-32" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "yt-skeleton h-4 w-full mb-2" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "yt-skeleton h-3 w-3/4" })
                ]
              }
            )
          ]
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#717171", fontSize: 13 }, children: error }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#555", fontSize: 12, marginTop: 6 }, children: "Check your API key in Settings, or your quota may be exceeded." })
        ]
      }
    );
  }
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: Array.from({ length: 8 }).map((_, i) => (
      // biome-ignore lint/suspicious/noArrayIndexKey: skeleton placeholders
      /* @__PURE__ */ jsxRuntimeExports.jsx(VideoCardSkeleton, {}, i)
    )) });
  }
  if (videos.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-12 text-center", "data-ocid": "video.empty_state", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#717171", fontSize: 15 }, children: emptyMessage || "No videos found." }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: videos.map((v2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    VideoCard,
    {
      video: v2,
      onWatch,
...
function ChannelPage({
  ...
  const ambientCanvasRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    let cancelled = false;
    setLoading(true);
    setError(null);
    setChannel(null);
    setVideos([]);
    fetchChannelVideos(channelId).then(({ channel: ch, videos: vids }) => {
      if (!cancelled) {
        setChannel(ch);
        setVideos(vids);
        setLoading(false);
  ...
  function getAvatarColor2(name) {
    let hash = 0;
    for (let i = 0; i < name.length; i++)
      hash = name.charCodeAt(i) + ((hash << 5) - hash);
    return AVATAR_COLORS2[Math.abs(hash) % AVATAR_COLORS2.length];
  }
  const avatarColor = channel ? getAvatarColor2(channel.title) : "#ff0000";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fade-in", "data-ocid": "channel.panel", children: [
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "svg",
              {
                ...
                fill: "#f1f1f1",
                viewBox: "0 0 24 24",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z" })
              }
            ),
            "Back"
          ]
            ...
            loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              "div",
              {
                style: {
                  ...
                  background: (channel == null ? void 0 : channel.thumbnail) ? "transparent" : avatarColor,
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  fontSize: 32,
                ...
                children: (channel == null ? void 0 : channel.thumbnail) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                    src: channel.thumbnail,
                    alt: channel == null ? void 0 : channel.title,
                    style: { width: "100%", height: "100%", objectFit: "cover" }
                  }
                ) : ((_a2 = channel == null ? void 0 : channel.title) == null ? void 0 : _a2.charAt(0).toUpperCase()) || "C"
              }
            ),
            loading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h1",
                {
                  ...
                  children: channel == null ? void 0 : channel.title
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 13, color: "#aaa" }, children: channel ? formatSubscribers(channel.subscriberCount) : "" }),
              (channel == null ? void 0 : channel.description) && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  className: "line-clamp-2",
                  style: {
            ...
            !loading && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                style: {
                  ...
                  boxShadow: subscribed ? "none" : "0 2px 8px rgba(255,255,255,0.15)"
                },
    ...
    !loading && !error && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "14px 14px 6px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { style: { fontSize: 16, fontWeight: 600, color: "#f1f1f1" }, children: "Videos" }),
      videos.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { fontSize: 12, color: "#717171", marginTop: 2 }, children: [
        videos.length,
        " videos"
      ] })
    ] }),
    error && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#ff5555", fontSize: 14 }, children: error })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      VideoGrid,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { fontSize: 11, color: "#444" }, children: [
      "© ",
...
function getHistory() {
  try {
    ...
    return parsed.sort((a, b) => b.watchedAt - a.watchedAt).slice(0, MAX_HISTORY);
  } catch {
    return [];
  }
}
...
function updateResumeTime(id, seconds) {
  try {
    const history = getHistory();
...
function HistoryPage({ onWatch, onChannelClick }) {
  const [history, setHistory] = reactExports.useState(() => getHistory());
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "svg",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M13 3a9 9 0 1 0 9 9h-2a7 7 0 1 1-7-7v3l4-4-4-4v3zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#717171", fontSize: 16, fontWeight: 500 }, children: "No watch history yet." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#555", fontSize: 13, marginTop: 6 }, children: "Videos you watch will appear here." })
        ]
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fade-in", "data-ocid": "history.panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3", children: history.map((entry, i) => {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                onClick: () => onWatch(
                  entry.id,
                  entry.resumeTime > 0 ? entry.resumeTime : void 0
                ),
                "data-ocid": i < 3 ? `history.item.${i + 1}` : void 0,
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    style: {
                    ...
                    children: [
                      entry.thumbnail ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "img",
                        {
                          src: entry.thumbnail,
                          alt: entry.title,
                      ...
                      entry.duration && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          style: {
                            position: "absolute",
                ...
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      children: entry.channelTitle
                    }
                  )
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 12, color: "#555", marginBottom: 4 }, children: timeAgo(new Date(entry.watchedAt).toISOString()) }),
              resumeStr && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
                  style: {
                    display: "inline-flex",
...
function HomePage({
  ...
  const [loading, setLoading] = reactExports.useState(true);
  const [error, setError] = reactExports.useState(null);
  const [activeChip, setActiveChip] = reactExports.useState(initialChip || "home");
  const [refreshKey, setRefreshKey] = reactExports.useState(0);
  const [hasHistory, setHasHistory] = reactExports.useState(false);
  reactExports.useEffect(() => {
    setRefreshKey((k) => k + 1);
  }, []);
      ...
      try {
        if (activeChip === "home") {
          ...
          if (history.length > 0) {
            ...
            const historyCategoryIds = history.slice(0, 5).map((h) => h.categoryId || "").filter(Boolean);
            ...
            if (!cancelled) {
              if (results.length >= 6) {
                ...
                const trending = await fetchTrending(void 0);
                const resultIds = new Set(results.map((v2) => v2.id));
                const padded = trending.filter((v2) => !resultIds.has(v2.id));
                setVideos([...results, ...padded]);
              }
              setLoading(false);
            }
          } else {
            const data = await fetchTrending(void 0);
            if (!cancelled) {
              setVideos(data);
              setLoading(false);
            }
  ...
  const sectionTitle = activeChip === "home" && hasHistory ? "Recommended" : baseSectionTitle;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fade-in", children: [
        ...
        children: CHIPS.map((chip) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: chip.emoji }),
    ...
    !loading && !error && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "16px 14px 8px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "h2",
        {
          style: {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: sectionEmoji }),
            " ",
            sectionTitle
          ]
        }
      ),
      videos.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { fontSize: 13, color: "#717171", marginTop: 2 }, children: [
        videos.length,
        " videos"
      ] })
    ] }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fade-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { style: { fontSize: 14, fontWeight: 400, color: "#717171" }, children: [
          "Results for “",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#f1f1f1", fontWeight: 500 }, children: query }),
          "”"
        ] })
      }
    ),
...
function SettingsPage({ onClearKey }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fade-in", style: { maxWidth: 720 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "h2",
      {
        style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: sectionStyle, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 14, color: "#aaa", marginBottom: 16 }, children: "Manage your YouTube Data API v3 key." }),
      currentKey && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          style: {
            background: "#2d2d2d",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 12, color: "#aaa", marginBottom: 4 }, children: "Current Key" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: sectionStyle, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 14, color: "#aaa", marginBottom: 16 }, children: "This will clear your API key and return to setup." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: sectionStyle, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h3",
        {
          ...
          children: "About GlassTube"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 14, color: "#aaa", lineHeight: 1.6 }, children: "GlassTube is a YouTube browsing experience. All video playback is powered by the YouTube embed player." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { fontSize: 13, color: "#717171", marginTop: 12 }, children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        ". Built with ♥ using",
        " ",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3 mb-8", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "svg",
                {
                  ...
                  fill: "none",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width: "48", height: "34", rx: "8", fill: "#FF0000" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M20 10L32 17L20 24V10Z", fill: "white" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "A YouTube Data API v3 key is required to load videos."
              }
            ),
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "a",
                    {
                      ...
                      rel: "noopener noreferrer",
                      style: { color: "#3ea6ff", textDecoration: "none" },
                      children: "Get one from Google Cloud Console"
                    }
                  )
                ]
              }
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontWeight: 600, color: "#f1f1f1", marginBottom: 8 }, children: "Quick steps:" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "1. Go to Google Cloud Console" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "2. Create a project & enable YouTube Data API v3" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "3. Create credentials → API Key" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "4. Paste it above and click Get Started" })
                ]
              }
            )
          ]
...
function useAmbientMode(videoId, canvasRef) {
  reactExports.useEffect(() => {
...
function WatchPage({
  ...
  const [allRelated, setAllRelated] = reactExports.useState([]);
  const [relatedPage, setRelatedPage] = reactExports.useState(1);
  const [allComments, setAllComments] = reactExports.useState([]);
  const [commentsPage, setCommentsPage] = reactExports.useState(1);
  const [loading, setLoading] = reactExports.useState(true);
  ...
  const [error, setError] = reactExports.useState(null);
  const [subscribed, setSubscribed] = reactExports.useState(false);
  const [channelSubscriberCount, setChannelSubscriberCount] = reactExports.useState("");
  const [playerHovered, setPlayerHovered] = reactExports.useState(false);
  const [isFullscreen, setIsFullscreen] = reactExports.useState(false);
  const [fsAnimating, setFsAnimating] = reactExports.useState(false);
  const [copySuccess, setCopySuccess] = reactExports.useState(false);
  const [miniPlaying, setMiniPlaying] = reactExports.useState(true);
  const [videoSizeIndex, setVideoSizeIndex] = reactExports.useState(1);
  const [sizeControlsVisible, setSizeControlsVisible] = reactExports.useState(false);
  const [tapOverlayEnabled, setTapOverlayEnabled] = reactExports.useState(true);
  const sizeHideTimer = reactExports.useRef(null);
  const ambientCanvasRef = reactExports.useRef(null);
  const iframeRef = reactExports.useRef(null);
  const playerCardRef = reactExports.useRef(null);
  const playerWrapRef = reactExports.useRef(null);
  const startTimeRef = reactExports.useRef(Date.now());
  const currentResumeRef = reactExports.useRef(startTime);
  const isPlayingRef = reactExports.useRef(false);
  const dragStartY = reactExports.useRef(0);
  const hasScrolledRef = reactExports.useRef(false);
    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (!entry.isIntersecting && hasScrolledRef.current) {
          onMinimize == null ? void 0 : onMinimize(currentResumeRef.current);
        }
      },
      { threshold: 0 }
    );
  ...
  reactExports.useEffect(() => {
    ...
    const handleMessage = (e) => {
      try {
        ...
        if ((data == null ? void 0 : data.event) === "onStateChange") {
          if (data.info === 1) {
            isPlayingRef.current = true;
            setMiniPlaying(true);
            startTimeRef.current = Date.now() - (currentResumeRef.current - startTime) * 1e3;
  ...
  reactExports.useEffect(() => {
    ...
    async function loadAll() {
      try {
        ...
        setVideo(data);
        setLoading(false);
        if (data == null ? void 0 : data.channelId) {
          fetch(
            `https://www.googleapis.com/youtube/v3/channels?part=statistics&id=${data.channelId}&key=${getApiKey()}`
          ).then((r) => r.json()).then((json) => {
            var _a2, _b2, _c2;
            const count = (_c2 = (_b2 = (_a2 = json.items) == null ? void 0 : _a2[0]) == null ? void 0 : _b2.statistics) == null ? void 0 : _c2.subscriberCount;
            if (count && !cancelled) {
              const n = Number.parseInt(count, 10);
              let formatted = "";
              if (n >= 1e6)
                formatted = `${(n / 1e6).toFixed(1)}M subscribers`;
              else if (n >= 1e3)
                formatted = `${(n / 1e3).toFixed(0)}K subscribers`;
        ...
        if (data) {
          ...
          saveToHistory({
            ...
            resumeTime: (existing == null ? void 0 : existing.resumeTime) ?? startTime
          });
        }
        const history = getHistory();
        const historyTitles = history.map((h) => h.title);
        const historyCategoryIds = [];
        if (data == null ? void 0 : data.categoryId) historyCategoryIds.push(data.categoryId);
        fetchInterestVideos(historyTitles, historyCategoryIds).then((rel) => {
          if (!cancelled) {
            const filtered = rel.filter((v2) => v2.id !== videoId);
  ...
  async function handleFullscreen() {
    ...
    try {
      if (document.fullscreenElement) {
        ...
        if ((_a2 = screen.orientation) == null ? void 0 : _a2.lock) {
          try {
  ...
  const swipeDragX = reactExports.useRef(0);
  const swipeContainerRef = reactExports.useRef(null);
  const swipeAnimating = reactExports.useRef(false);
  ...
  const handleSwipeTouchEnd = (e) => {
    ...
    if (dy > 80 && !swipeAnimating.current) {
      ...
      if (swipeContainerRef.current) {
        swipeContainerRef.current.style.transition = "transform 0.28s cubic-bezier(0.32,0.72,0,1), opacity 0.28s ease";
        swipeContainerRef.current.style.transform = "translateY(100%) scale(0.88) translateZ(0)";
        swipeContainerRef.current.style.opacity = "0";
      }
      setTimeout(() => onMinimize == null ? void 0 : onMinimize(currentResumeRef.current), 260);
    } else {
      if (swipeContainerRef.current) {
        swipeContainerRef.current.style.transition = "transform 0.32s cubic-bezier(0.22,1,0.36,1), opacity 0.32s ease";
        swipeContainerRef.current.style.transform = "translateY(0) scale(1) translateZ(0)";
    ...
    "div",
    {
      ...
      ` }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            ...
            {
              ref: playerWrapRef,
              className: fsAnimating ? isFullscreen ? "fs-animating-enter" : "fs-animating-exit" : "",
              style: {
                position: "relative",
                  ...
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        onClick: !isMini ? showSizeControls : void 0,
                        onKeyDown: !isMini ? (e) => {
                        ...
                        style: {
                          ...
                          boxShadow: playerHovered ? "0 24px 60px rgba(0,0,0,0.9), 0 8px 24px rgba(0,0,0,0.5), 0 2px 8px rgba(0,0,0,0.6), inset 0 1px 0 rgba(255,255,255,0.12)" : "0 16px 40px rgba(0,0,0,0.8), 0 4px 16px rgba(0,0,0,0.4), 0 2px 4px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.08)",
                          transform: playerHovered ? "rotateX(2deg) translateY(-2px) scale(1.005)" : "rotateX(0deg) translateY(0) scale(1)",
                        ...
                        children: [
                          ...
                          !isMini && tapOverlayEnabled && /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              style: {
                                position: "absolute",
                          ...
                          isMini && /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              style: {
                                position: "absolute",
                                inset: 0,
                                zIndex: 30,
                                background: "linear-gradient(to bottom, transparent 45%, rgba(0,0,0,0.82))",
                                display: "flex",
                                flexDirection: "column",
                                      ...
                                      "button",
                                      {
                                        ...
                                        onClick: (e) => {
                                          ...
                                          if (miniPlaying) {
                                            ...
                                            (_d2 = (_c2 = iframeRef.current) == null ? void 0 : _c2.contentWindow) == null ? void 0 : _d2.postMessage(
                                              JSON.stringify({
                                                event: "command",
                                                func: "playVideo",
                                                args: ""
                                        ...
                                        children: miniPlaying ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                                          "svg",
                                          {
                                            "aria-hidden": "true",
                                            width: "14",
                                      ...
                                      "button",
                                      {
                                        ...
                                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                                          "svg",
                                          {
                                            ...
                                            viewBox: "0 0 24 24",
                                            fill: "currentColor",
                                            children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M7 14H5v5h5v-2H7v-3zm-2-4h2V7h3V5H5v5zm12 7h-3v2h5v-5h-2v3zM14 5v2h3v3h2V5h-5z" })
                                          }
                                        )
                                      }
                                    ),
                                      ...
                                      "button",
                                      {
                                        ...
                                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                                          "svg",
                                          {
                                            ...
                                            viewBox: "0 0 24 24",
                                            fill: "currentColor",
                                            children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z" })
                                          }
                                        )
                                      }
                                    )
                          ...
                          !isMini && /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              style: {
                                ...
                                transform: sizeControlsVisible ? "scale(1) translateY(0)" : "scale(0.88) translateY(6px)",
                                transition: "opacity 0.3s ease, transform 0.3s ease",
                                pointerEvents: sizeControlsVisible ? "auto" : "none"
                              },
                              "data-ocid": "player.size.panel",
                              children: VIDEO_SIZES.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "button",
                                {
                                  type: "button",
                                  onClick: (e) => {
                                  ...
                                  style: {
                                    ...
                                    height: 34,
                                    borderRadius: 10,
                                    background: videoSizeIndex === i ? "rgba(200,0,0,0.75)" : "rgba(0,0,0,0.62)",
                                    backdropFilter: "blur(14px)",
                                    WebkitBackdropFilter: "blur(14px)",
                                    border: `1px solid ${videoSizeIndex === i ? "rgba(255,80,80,0.5)" : "rgba(255,255,255,0.22)"}`,
                                    color: "#fff",
                                    ...
                                    alignItems: "center",
                                    justifyContent: "center",
                                    boxShadow: videoSizeIndex === i ? "0 2px 16px rgba(200,0,0,0.4), 0 1px 4px rgba(0,0,0,0.5)" : "0 2px 12px rgba(0,0,0,0.5)",
                                    transition: "background 0.22s ease, border-color 0.22s ease, box-shadow 0.22s ease, font-size 0.15s ease",
                                    transform: videoSizeIndex === i ? "scale(1.08)" : "scale(1)"
                                  },
                                  title: s.title,
                          ...
                          !isMini && onMinimize && /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "button",
                            {
                              type: "button",
                              onClick: (e) => {
                          ...
                          !isMini && /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "button",
                            {
                              ...
                              children: isFullscreen ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "svg",
                                {
                                  "aria-hidden": "true",
                                  width: "14",
                                  ...
                                  fill: "#ffffff",
                                  viewBox: "0 0 24 24",
                                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M5 16h3v3h2v-5H5v2zm3-8H5v2h5V5H8v3zm6 11h2v-3h3v-2h-5v5zm2-11V5h-2v5h5V8h-3z" })
                                }
                              ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "svg",
                                {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", "data-ocid": "video.loading_state", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                  ...
                  ) : video ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        type: "button",
                    ...
                    descExpanded && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              ...
                              children: video.description || "No description available."
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "button",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "button",
                        {
                          ...
                          onClick: () => onChannelClick && video && onChannelClick(video.channelId, video.channelTitle),
                          "data-ocid": "player.channel.button",
                          children: [
                            video.channelThumbnail ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "img",
                              {
                                src: video.channelThumbnail,
                                alt: video.channelTitle,
                              ...
                              "div",
                              {
                                ...
                                children: video.channelTitle.charAt(0).toUpperCase()
                              }
                            ),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "left" }, children: [
                              ...
                              channelSubscriberCount && /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "div",
                                {
                                  style: {
                                    fontSize: 12,
                                  ...
                                  children: channelSubscriberCount
                                }
                              )
                            ] })
                          ]
                        ...
                        children: [
                              ...
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  "svg",
                                  {
                                    ...
                                    fill: "#f1f1f1",
                                    viewBox: "0 0 24 24",
                                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M1 21h4V9H1v12zm22-11c0-1.1-.9-2-2-2h-6.31l.95-4.57.03-.32c0-.41-.17-.79-.44-1.06L14.17 1 7.59 7.59C7.22 7.95 7 8.45 7 9v10c0 1.1.9 2 2 2h9c.83 0 1.54-.5 1.84-1.22l3.02-7.05c.09-.23.14-.47.14-.73v-2z" })
                                  }
                                ),
                                /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  "span",
                                  {
                                    ...
                                    children: formatLikes(video.likeCount)
                                  }
                                )
                              ]
                            }
                              ...
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  "svg",
                                  {
                                    ...
                                    fill: "#f1f1f1",
                                    viewBox: "0 0 24 24",
                                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67V7z" })
                                  }
                                ),
                                /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  "span",
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "button",
                            {
                              ...
                              children: [
                                copySuccess ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  "svg",
                                  {
                                    "aria-hidden": "true",
                                    width: "12",
                                    ...
                                    fill: "#4caf50",
                                    viewBox: "0 0 24 24",
                                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z" })
                                  }
                                ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  "svg",
                                  {
                                    ...
                                    fill: "#f1f1f1",
                                    viewBox: "0 0 24 24",
                                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z" })
                                  }
                                ),
                                /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  "span",
                                  {
                                    style: { overflow: "hidden", textOverflow: "ellipsis" },
                                    children: copySuccess ? "Copied!" : "Copy Link"
                                  }
                                )
                              ]
                            }
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "comments.panel", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "svg",
                          {
                            ...
                            fill: "#f1f1f1",
                            viewBox: "0 0 24 24",
                            children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M21.99 4c0-1.1-.89-2-1.99-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h14l4 4-.01-18z" })
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 15, fontWeight: 600, color: "#f1f1f1" }, children: "Comments" })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "svg",
                        {
                ...
                commentsOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: "animate-fade-in",
                    style: { paddingBottom: 8 },
                    "data-ocid": "comments.list",
                    children: commentsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "0 12px 8px" }, children: Array.from({ length: 5 }).map((_, i) => (
                      // biome-ignore lint/suspicious/noArrayIndexKey: skeleton
                      /* @__PURE__ */ jsxRuntimeExports.jsx(CommentSkeleton, {}, i)
                    ...
                    ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "0 12px 4px" }, children: [
                      comments.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          className: "flex gap-3",
                          style: { marginBottom: 16 },
                          "data-ocid": i < 3 ? `comments.item.${i + 1}` : void 0,
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "div",
                              {
                                ...
                                children: c.authorAvatar ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  "img",
                                  {
                                    src: c.authorAvatar,
                                    alt: c.authorName,
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                "div",
                                {
                                  ...
                                  children: [
                                    ...
                                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 11, color: "#717171" }, children: timeAgo(c.publishedAt) })
                                  ]
                                }
                              ),
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                              ...
                              c.likeCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                "div",
                                {
                                  className: "flex items-center gap-1",
                                  style: { marginTop: 5 },
                                  children: [
                                    ...
                                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 11, color: "#717171" }, children: c.likeCount.toLocaleString() })
                                  ]
                                }
                              )
                            ] })
                      ...
                      hasMoreComments && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2", children: [
                ...
                relatedLoading ? Array.from({ length: 5 }).map((_, i) => (
                  // biome-ignore lint/suspicious/noArrayIndexKey: skeleton placeholders
                  /* @__PURE__ */ jsxRuntimeExports.jsx(RelatedSkeleton, {}, i)
                  ...
                  related.map((v2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      type: "button",
                      ...
                      onClick: () => onWatch(v2.id),
                      "data-ocid": i < 3 ? `related.item.${i + 1}` : void 0,
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "div",
                          {
                            ...
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "img",
                                {
                                  src: v2.thumbnail || getYtThumbnail(v2.id),
                                  alt: v2.title,
                                  className: "w-full h-full object-cover",
                                  loading: "lazy",
                                  onError: (e) => {
                                    const img = e.target;
                                    const fb = getYtThumbnail(v2.id);
                                    if (img.src !== fb) img.src = fb;
                                  }
                                }
                              ),
                              v2.duration && /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "div",
                                {
                                  style: {
                                    position: "absolute",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 py-1", children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 12, color: "#717171" }, children: v2.channelTitle }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 12, color: "#717171" }, children: timeAgo(v2.publishedAt) })
                        ] })
                      ]
                    },
                    v2.id
                  )),
                  hasMoreRelated && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "4px 12px 12px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
...
function RelatedSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 px-3 py-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 pt-1 space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "yt-skeleton h-3.5 w-full", style: { borderRadius: 4 } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "yt-skeleton h-3 w-3/4", style: { borderRadius: 4 } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "yt-skeleton h-3 w-1/2", style: { borderRadius: 4 } })
    ] })
  ] });
}
function CommentSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", style: { marginBottom: 16 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "yt-skeleton flex-shrink-0",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 pt-1 space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "yt-skeleton h-3 w-1/3", style: { borderRadius: 4 } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "yt-skeleton h-3 w-full", style: { borderRadius: 4 } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "yt-skeleton h-3 w-3/4", style: { borderRadius: 4 } })
    ] })
  ] });
}
...
function App() {
  var _a2;
  const [apiReady, setApiReady] = reactExports.useState(hasApiKey);
  const [navStack, setNavStack] = reactExports.useState(loadPersistedState);
  const [backgroundNavStack, setBackgroundNavStack] = reactExports.useState(loadBgState);
  ...
  const [miniPos, setMiniPos] = reactExports.useState(() => ({
  ...
  const miniDragging = reactExports.useRef(false);
  const miniDragStart = reactExports.useRef({ tx: 0, ty: 0, px: 0, py: 0 });
  const miniDragTotal = reactExports.useRef(0);
  const current = navStack[navStack.length - 1];
  const currentPage = current.page;
  const channelId = current.channelId ?? "";
  const searchQuery = current.searchQuery ?? "";
  const isWatchPage = currentPage === "watch";
  const miniScale = MINI_W / (typeof window !== "undefined" ? window.innerWidth : 390);
  ...
  const pushPage = reactExports.useCallback((state) => {
    window.history.pushState({ depth: 1 }, "");
    setNavStack((prev) => [...prev, state]);
  }, []);
  const handleNavigate = reactExports.useCallback((page) => {
    setNavStack([{ page }]);
  }, []);
  ...
  const handleWatch = reactExports.useCallback((id, resumeTime) => {
  ...
  const handleChannelClick = reactExports.useCallback(
    (id, _title) => {
  ...
  const handleMinimize = reactExports.useCallback(
    (_currentTime) => {
      ...
      setNavStack((prev) => {
        ...
        return backgroundNavStack.length > 0 ? backgroundNavStack : [{ page: "home" }];
      });
    },
    [backgroundNavStack]
  );
  ...
  const handleMiniTouchStart = reactExports.useCallback(
    (e) => {
  ...
  const handleMiniTouchMove = reactExports.useCallback((e) => {
    var _a3;
    ...
    const outerDiv = (_a3 = innerRef.current) == null ? void 0 : _a3.parentElement;
    if (outerDiv) {
      outerDiv.style.clipPath = `inset(${newY}px ${Math.max(0, iw - newX - MINI_W)}px ${Math.max(0, ih - newY - MINI_H)}px ${newX}px round 16px)`;
    }
  }, []);
  const handleMiniTouchEnd = reactExports.useCallback(() => {
    miniDragging.current = false;
    setIsDragging(false);
    if (miniRef.current) {
      const left = Number.parseFloat(miniRef.current.style.left) || miniDragStart.current.px;
      const top = Number.parseFloat(miniRef.current.style.top) || miniDragStart.current.py;
      setMiniPos({ x: left, y: top });
    }
  }, []);
  const handleMiniTap = reactExports.useCallback(() => {
  ...
  if (!apiReady) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SetupPage, { onSetup: () => setApiReady(true) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster, {})
    ] });
  }
  function renderBackgroundPage(state) {
    ...
    if (page === "channel" && cId) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        ChannelPage,
        {
          channelId: cId,
          onWatch: handleWatch,
          onBack: () => setNavStack((prev) => prev.length > 1 ? prev.slice(0, -1) : prev),
    ...
    if (page === "settings") {
      return /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsPage, { onClearKey: () => setApiReady(false) });
    }
    if (page === "history") {
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        HistoryPage,
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(HomePage, { onWatch: handleWatch, onChannelClick: handleChannelClick });
  }
  function renderPage() {
  ...
  const navPage = isWatchPage ? ((_a2 = backgroundNavStack[backgroundNavStack.length - 1]) == null ? void 0 : _a2.page) || "home" : currentPage;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", style: { background: "#000000" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      TopBar,
      {
    ...
    canInstall && !bannerDismissed && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: {
          position: "fixed",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: "Install Modx Tube"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#aaa", fontSize: 11, marginTop: 2 }, children: "Add to home screen for the full app experience" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "main",
      {
        style: {
          ...
          paddingBottom: isWatchPage ? 0 : "calc(60px + env(safe-area-inset-bottom, 0px))",
          minHeight: "100vh"
        },
        children: renderPage()
      }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: `
      ...
      ` }),
    activeVideo && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          style: {
            ...
            clipPath: isWatchPage ? "inset(0px 0px 0px 0px round 0px)" : `inset(${miniPos.y}px ${Math.max(0, window.innerWidth - miniPos.x - MINI_W)}px ${Math.max(0, window.innerHeight - miniPos.y - MINI_H)}px ${miniPos.x}px round 16px)`,
            transition: isDragging ? "none" : "clip-path 0.35s cubic-bezier(0.32,0.72,0,1)",
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                ...
                transform: isWatchPage ? "translate3d(0,0,0) scale(1)" : `translate3d(${miniPos.x}px, ${miniPos.y}px, 0) scale(${miniScale})`,
      ...
      !isWatchPage && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ref: miniRef,
          style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(BottomNav, { currentPage: navPage, onNavigate: handleNavigate }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster, {})
  ] });
}
...
Service({
  ...
  "querySearchVideos": Func([], [Text], []),
  "queryTrendingVidos": Func([], [Text], []),
  "queryVideoDetails": Func([], [Text], []),
  "queryYoutubeApi": Func([YoutubeEndpoint], [Text], []),
  "saveCallerUserProfile": Func([UserProfile], [], []),
  "setApiKey": Func([Vec(Nat8)], [], []),
  "transform": Func(
    [TransformationInput],
