...
function TopBar({ onSearch, onNavigate, currentQuery }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "header",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center px-3 gap-2", style: { height: 64 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center", style: { gap: 1 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#FF0000", fontWeight: 800, fontSize: 18 }, children: "MODX" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#ffffff", fontWeight: 800, fontSize: 18 }, children: "TUBE" })
                  ]
                }
              )
            ]
    ...
    try {
      ...
      if (res.ok) {
        ...
        for (const item of data.items || []) {
          const thumb = ((_c2 = (_b2 = (_a2 = item.snippet) == null ? void 0 : _a2.thumbnails) == null ? void 0 : _b2.default) == null ? void 0 : _c2.url) || ((_f2 = (_e2 = (_d2 = item.snippet) == null ? void 0 : _d2.thumbnails) == null ? void 0 : _e2.medium) == null ? void 0 : _f2.url) || "";
...
async function fetchTrending(categoryId) {
  ...
  const videos = (data.items || []).map((item) => {
    ...
    return {
      ...
      thumbnail: ((_b2 = (_a3 = item.snippet.thumbnails) == null ? void 0 : _a3.maxres) == null ? void 0 : _b2.url) || ((_d2 = (_c2 = item.snippet.thumbnails) == null ? void 0 : _c2.high) == null ? void 0 : _d2.url) || ((_f2 = (_e2 = item.snippet.thumbnails) == null ? void 0 : _e2.medium) == null ? void 0 : _f2.url) || "",
      viewCount: ((_g2 = item.statistics) == null ? void 0 : _g2.viewCount) || "0",
      likeCount: ((_h2 = item.statistics) == null ? void 0 : _h2.likeCount) || "0",
      publishedAt: item.snippet.publishedAt,
      description: item.snippet.description,
      categoryId: item.snippet.categoryId,
      duration: parseDuration(((_i2 = item.contentDetails) == null ? void 0 : _i2.duration) || "")
    };
  });
...
async function searchVideos(query) {
  ...
  const results = (data.items || []).map(
    (item) => {
      ...
      return {
        id: ((_a3 = item.id) == null ? void 0 : _a3.videoId) || item.id,
        title: item.snippet.title,
        channelTitle: item.snippet.channelTitle,
        channelId: item.snippet.channelId,
        thumbnail: ((_c2 = (_b2 = item.snippet.thumbnails) == null ? void 0 : _b2.high) == null ? void 0 : _c2.url) || ((_e2 = (_d2 = item.snippet.thumbnails) == null ? void 0 : _d2.medium) == null ? void 0 : _e2.url) || "",
        publishedAt: item.snippet.publishedAt,
        description: item.snippet.description
      };
    }
...
async function fetchVideoDetails(videoId) {
  ...
  const video = {
    ...
    channelTitle: item.snippet.channelTitle,
    channelId: item.snippet.channelId,
    thumbnail: ((_d2 = (_c2 = item.snippet.thumbnails) == null ? void 0 : _c2.maxres) == null ? void 0 : _d2.url) || ((_f2 = (_e2 = item.snippet.thumbnails) == null ? void 0 : _e2.high) == null ? void 0 : _f2.url) || "",
    viewCount: ((_g2 = item.statistics) == null ? void 0 : _g2.viewCount) || "0",
    likeCount: ((_h2 = item.statistics) == null ? void 0 : _h2.likeCount) || "0",
    publishedAt: item.snippet.publishedAt,
    description: item.snippet.description,
...
function VideoCard({ video, onWatch, index: index2 }) {
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 13, color: "#aaaaaa", fontWeight: 400 }, children: video.channelTitle })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h3",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: 13, color: "#717171" }, children: [
...
function VideoCardSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "video.loading_state", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "yt-skeleton w-8 h-8 rounded-full flex-shrink-0" }),
...
function VideoGrid({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: videos.map((v2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(VideoCard, { video: v2, onWatch, index: i }, v2.id)) });
}
const CHIPS = [
...
function HomePage({ onWatch }) {
  ...
  const [activeChip, setActiveChip] = reactExports.useState("home");
...
function SearchPage({ query, onWatch }) {
...
function WatchPage({ videoId, onWatch }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fade-in", "data-ocid": "player.panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { aspectRatio: "16/9", background: "#000", width: "100%" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "iframe",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 pt-3", children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", "data-ocid": "video.loading_state", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { fontSize: 13, color: "#717171", marginBottom: 12 }, children: [
        formatViews(video.viewCount),
        " views •",
        " ",
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: descExpanded ? "Show less" : "...more"
              }
            )
          ]
        }
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: v2.thumbnail ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                    src: v2.thumbnail,
                    alt: v2.title,
...
function App() {
  ...
  const handleWatch = reactExports.useCallback((id) => {
    setWatchId(id);
  ...
  function renderPage() {
    if (currentPage === "watch" && watchId) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx(WatchPage, { videoId: watchId, onWatch: handleWatch });
    }
    if (currentPage === "search") {
      return /* @__PURE__ */ jsxRuntimeExports.jsx(SearchPage, { query: searchQuery, onWatch: handleWatch });
    }
    if (currentPage === "settings") {
      return /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsPage, { onClearKey: () => setApiReady(false) });
    }
    if (currentPage === "history") {
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-8 text-center", style: { paddingTop: 48 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#717171", fontSize: 15 }, children: "Watch history coming soon." }) });
    }
    return /* @__PURE__ */ jsxRuntimeExports.jsx(HomePage, { onWatch: handleWatch });
  }
