...
async function fetchRelatedVideos(videoId, categoryId) {
  var _a2;
  const key = getApiKey();
  try {
    ...
    if (res.ok) {
      const data = await res.json();
      if (((_a2 = data.items) == null ? void 0 : _a2.length) > 0) {
  ...
  if (categoryId) {
    return (await fetchTrending(categoryId)).map((v2) => ({ ...v2 }));
  }
          ...
          if (history.length > 0) {
            ...
            if (!cancelled) {
              if (related.length >= 8) {
                ...
                const relatedIds = new Set(related.map((v2) => v2.id));
                const padded = trending.filter((v2) => !relatedIds.has(v2.id));
...
function WatchPage({
  ...
  reactExports.useEffect(() => {
    ...
    fetchVideoDetails(videoId).then((data) => {
      if (!cancelled) {
        ...
        fetchRelatedVideos(videoId, data == null ? void 0 : data.categoryId).then((rel) => {
          if (!cancelled) {
            setRelated(rel);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fade-in", "data-ocid": "player.panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative", padding: "12px 12px 0" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "canvas",
        {
          ref: ambientCanvasRef,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", "data-ocid": "video.loading_state", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { fontSize: 13, color: "#717171", marginBottom: 10 }, children: [
            formatViews(video.viewCount),
            " views •",
            " ",
                        ...
                        "button",
                        {
                          ...
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "svg",
                            {
                              ...
                              fill: "#f1f1f1",
                              viewBox: "0 0 24 24",
                              children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M15 3H6c-.83 0-1.54.5-1.84 1.22l-3.02 7.05c-.09.23-.14.47-.14.73v2c0 1.1.9 2 2 2h6.31l-.95 4.57-.03.32c0 .41.17.79.44 1.06L9.83 23l6.59-6.59c.36-.36.58-.86.58-1.41V5c0-1.1-.9-2-2-2zm4 0v12h4V3h-4z" })
                            }
                          )
                        }
                      )
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "svg",
                        {
                          ...
                          fill: "#f1f1f1",
                          viewBox: "0 0 24 24",
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7s-.04-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.04.81 1.66 0 3-1.34 3-3s-1.34-3-3-3-3 1.34-3 3c0 .24.04.47.09.7L8.04 9.81C7.5 9.31 6.79 9 6 9c-1.66 0-3 1.34-3 3s1.34 3 3 3c.79 0 1.5-.31 2.04-.81l7.12 4.16c-.05.21-.08.43-.08.65 0 1.61 1.31 2.92 2.92 2.92 1.61 0 2.92-1.31 2.92-2.92s-1.31-2.92-2.92-2.92z" })
                        }
                      ),
                      "Share"
                    ]
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "svg",
                        {
                          ...
                          fill: "#f1f1f1",
                          viewBox: "0 0 24 24",
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-5 14l-4-4-4 4V5h12v12l-4-4-4 4z" })
                        }
                      ),
                      "Save"
                    ]
                  ...
                  "button",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "svg",
                      {
                        ...
                        fill: "#f1f1f1",
                        viewBox: "0 0 24 24",
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M17 12h-5v5h5v-5zM16 1v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2h-1V1h-2zm3 18H5V8h14v11z" })
                      }
                    )
                  }
                )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2", children: [
      ...
      relatedLoading ? Array.from({ length: 6 }).map((_, i) => (
        // biome-ignore lint/suspicious/noArrayIndexKey: skeleton placeholders
