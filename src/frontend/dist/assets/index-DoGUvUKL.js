...
function App() {
  ...
  const [watchId, setWatchId] = reactExports.useState("");
  const [watchStartTime, setWatchStartTime] = reactExports.useState(0);
  ...
  const handleChannelClick = reactExports.useCallback((id, _title) => {
    setChannelId(id);
