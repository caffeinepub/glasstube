...
function VideoGrid({
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "video-grid", children: Array.from({ length: 8 }).map((_, i) => (
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "video-grid", children: videos.map((v2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    VideoCard,
    {
      video: v2,
      onWatch,
...
function WatchPage({
  ...
  const [_miniPlaying, setMiniPlaying] = reactExports.useState(true);
  const ambientCanvasRef = reactExports.useRef(null);
  const iframeRef = reactExports.useRef(null);
  const playerCardRef = reactExports.useRef(null);
  const swipeOverlayRef = reactExports.useRef(null);
                  ...
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        onTouchStart: !isMini ? handleSwipeTouchStart : void 0,
                        onTouchMove: !isMini ? handleSwipeTouchMove : void 0,
                        onTouchEnd: !isMini ? handleSwipeTouchEnd : void 0,
                        style: {
                              ...
                              children: [
                                copySuccess ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  ...
                                  "svg",
                                  {
                                    ...
                                    fill: "#f1f1f1",
                                    viewBox: "0 0 24 24",
                                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z" })
                                  }
                                ),
                                /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  "span",
                                  {
                                    style: { overflow: "hidden", textOverflow: "ellipsis" },
                                    children: copySuccess ? "Copied!" : "Download"
                                  }
                                )
                              ]
                            }
...
function App() {
  ...
  const miniControlsRef = reactExports.useRef(null);
  ...
  const expandingFromMiniRef = reactExports.useRef(false);
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "main",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { maxWidth: 1400, margin: "0 auto", width: "100%" }, children: renderPage() })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: `
        ...
        activeVideo && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              className: isWatchPage && !expandingFromMiniRef.current ? "watch-enter" : "",
              style: {
                position: "fixed",
                top: 0,
                left: 0,
          ...
          !isWatchPage && activeVideo && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ref: miniControlsRef,
              style: {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    children: miniPlaying ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "svg",
                      {
                        "aria-hidden": "true",
                        width: "16",
