...
function WatchPage({
  ...
  const [subscribed, setSubscribed] = reactExports.useState(false);
  const [channelSubscriberCount, setChannelSubscriberCount] = reactExports.useState(null);
      ...
      try {
        ...
        if (data == null ? void 0 : data.channelId) {
          fetch(
            ...
            var _a3, _b2, _c2;
            const count = (_c2 = (_b2 = (_a3 = json.items) == null ? void 0 : _a3[0]) == null ? void 0 : _b2.statistics) == null ? void 0 : _c2.subscriberCount;
            if (count && !cancelled) {
              const n = Number.parseInt(count, 10);
              let formatted = "";
              if (n >= 1e6)
  ...
  reactExports.useEffect(() => {
    var _a3, _b2;
    if (isVisible === false) {
      (_b2 = (_a3 = iframeRef.current) == null ? void 0 : _a3.contentWindow) == null ? void 0 : _b2.postMessage(
  ...
  async function handleFullscreen() {
    ...
    try {
      if (document.fullscreenElement) {
        ...
        if ((_a3 = screen.orientation) == null ? void 0 : _a3.lock) {
          try {
  ...
  if (error) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-8 text-center", "data-ocid": "video.error_state", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#ff5555" }, children: error }) });
  }
                      ...
                      "div",
                      {
                        ...
                        children: [
                          ...
                          !isMini && onMinimize && /* @__PURE__ */ jsxRuntimeExports.jsx(
                            ...
                            {
                              type: "button",
                              onClick: () => onMinimize == null ? void 0 : onMinimize(currentResumeRef.current),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
                          ...
                          children: [
                            video.channelThumbnail ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                              ...
                              "div",
                              {
                                ...
                                children: (_a2 = video.channelTitle[0]) == null ? void 0 : _a2.toUpperCase()
                              }
                            ),
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          ...
                          style: {
                            background: subscribed ? "rgba(255,255,255,0.1)" : "rgba(255,0,0,0.85)",
                            color: "#fff",
                            border: "none",
                            borderRadius: 20,
                            padding: "7px 16px",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "comments.panel", children: [
                ...
                commentsOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: commentsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                    ...
                    ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "0 12px" }, children: [
                      comments.map((c, i) => {
                        var _a3;
                        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "div",
                          {
                            ...
                            children: [
                              c.authorAvatar ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "img",
                                {
                                  src: c.authorAvatar,
                                  alt: c.authorName,
                                ...
                                "div",
                                {
                                  ...
                                  children: (_a3 = c.authorName[0]) == null ? void 0 : _a3.toUpperCase()
                                }
                              ),
...
const IconPlay = () => /* @__PURE__ */ jsxRuntimeExports.jsx(
  "svg",
  {
    width: "18",
    height: "18",
...
const IconPause = () => /* @__PURE__ */ jsxRuntimeExports.jsx(
  "svg",
  {
    width: "18",
    height: "18",
...
const IconClose = () => /* @__PURE__ */ jsxRuntimeExports.jsx(
  "svg",
  {
    width: "16",
    height: "16",
...
const IconExpand = () => /* @__PURE__ */ jsxRuntimeExports.jsx(
  "svg",
  {
    width: "16",
    height: "16",
...
function MiniPlayerCard({
  ...
  const miniIframeRef = reactExports.useRef(null);
  const dragging = reactExports.useRef(false);
  const startTouch = reactExports.useRef({ x: 0, y: 0 });
  const startPos = reactExports.useRef({ x: 0, y: 0 });
  const totalDrag = reactExports.useRef(0);
  const seekDoneRef = reactExports.useRef(false);
  reactExports.useEffect(() => {
    const handleMessage = (e) => {
      var _a2, _b2;
      try {
        const data = typeof e.data === "string" ? JSON.parse(e.data) : e.data;
        if ((data == null ? void 0 : data.event) === "onReady" && !seekDoneRef.current) {
          seekDoneRef.current = true;
          if (startTime > 0) {
            (_b2 = (_a2 = miniIframeRef.current) == null ? void 0 : _a2.contentWindow) == null ? void 0 : _b2.postMessage(
              JSON.stringify({
                event: "command",
                func: "seekTo",
                args: [startTime, true]
            ...
            setTimeout(() => {
              var _a3, _b3;
              (_b3 = (_a3 = miniIframeRef.current) == null ? void 0 : _a3.contentWindow) == null ? void 0 : _b3.postMessage(
                JSON.stringify({
                  event: "command",
                  func: "playVideo",
                  args: ""
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        ...
        willChange: "transform",
        transform: "translateZ(0)",
        animation: exiting ? "miniOut 0.28s cubic-bezier(0.32,0.72,0,1) forwards" : "miniIn 0.32s cubic-bezier(0.32,0.72,0,1)",
        userSelect: "none",
        ...
        border: "1px solid rgba(255,255,255,0.12)",
        boxShadow: "0 12px 40px rgba(0,0,0,0.75), 0 2px 8px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.08)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: `
        @keyframes miniIn {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              !playerReady && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                    position: "absolute",
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: "@keyframes miniSpin { to { transform: rotate(360deg); } }" })
                  ]
                }
              )
            ]
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: isPlaying ? /* @__PURE__ */ jsxRuntimeExports.jsx(IconPause, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(IconPlay, {})
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(IconExpand, {})
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
...
function App() {
  ...
  const handleMinimize = reactExports.useCallback(
    (currentTime) => {
      setActiveVideo(
        (prev) => prev ? { ...prev, startTime: currentTime } : null
      );
      setNavStack((prev) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", style: { background: "#000000" }, children: [
    ...
    activeVideo && !isWatchPage && /* @__PURE__ */ jsxRuntimeExports.jsx(
      MiniPlayerCard,
      {
        videoId: activeVideo.videoId,
        startTime: activeVideo.startTime,
      ...
      `${activeVideo.videoId}-${activeVideo.startTime}`
    ),
